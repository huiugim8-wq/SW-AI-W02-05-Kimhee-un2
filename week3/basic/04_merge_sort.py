...
def merge(arr, left, mid, right):
    ...
    while i < len(left_arr) and j < len(right_arr):
        ...
        # if left_arr[0] 38  <= right_arr[0]27:
            
            arr[k] = left_arr[i]
            i += 1
        else:
            arr[k] = right_arr[j]
            # arr[0] = right_arr[j]27
            j += 1 
            # j =1
        k += 1
...
# merge_sort_helper([38, 27, 43, 3], 0, 3)
...
# merge_sort_helper(arr, 0, 3) mid 1>> >>merge(arr, 0, 1, 3)  27,38, 3,43
# -------------------------------------------------------
# mid 1, merge_sort_helper(arr, 0, 1), merge_sort_helper(arr, 2, 3)

# merge_sort_helper(arr, 0, 1), mid 0, >>merge(arr, 0, 0, 1) 27,38
# --------------------------------------------------------
# merge_sort_helper(arr, 0, 0), merge_sort_helper(arr, 1, 1)

# merge_sort_helper(arr, 2, 3) mid2 >> merge(arr, 2, 2, 3) 3,43
# --------------------------------------------------------
# merge_sort_helper(arr, 2, 2),merge_sort_helper(arr, 3, 3)
